...
local function getDeviceSecret()
    ...
    return "1Ug26JILT6T8GsTyuFCoPMQZlTTV6U5S"
...
function publishTest()
    ...
    if sConnected then
        ...
        aLiYun.publish(
            ...
            "\"params\":{\"GeoLocation\":{\"CoordinateSystem\":1,\"Latitude\":"..tLocation.lng..",\"Longitude\":"..tLocation.lat..",\"Altitude\":"..gps.getAltitude().."}}",
            1,
            publishTestCb,
